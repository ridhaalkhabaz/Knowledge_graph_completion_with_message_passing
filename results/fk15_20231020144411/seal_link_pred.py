...
def evaluate_mrr(pos_val_pred, neg_val_pred, pos_test_pred, neg_test_pred):
    ...
    results = {}
    valid_mrr =  1./ranking_list_val.to(torch.float)
    test_mrr = 1./ranking_list_test.to(torch.float)
    print(valid_mrr, )
...
if args.dataset.startswith('ogbl'):
    ...
    print(path)
    dataset = FB15k_237(path)
    # dataset_test = FB15k_237(path, 'test')
    # dataset_val = FB15k_237(path, 'val')
